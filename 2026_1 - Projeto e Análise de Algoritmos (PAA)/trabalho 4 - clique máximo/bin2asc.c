...
/* Parâmetros do genbin.h embutidos */
...
void read_graph_DIMACS_bin(char *file) {
    ...
    /* CORREÇÃO AQUI: "rb" (Read Binary) garante que o Windows não corte o arquivo no meio */
...
int get_params(void) {
    ...
    if (Nr_vert == 0 || Nr_edges == 0) return 0;
    else return 1;
}
...
int main(int argc, char **argv) {
    ...
    printf("Convertendo %s para ASCII...\n", argv[1]);
